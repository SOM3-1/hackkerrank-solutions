...
function Activity(amountNew) {
    this.amount = amountNew;
    this.setAmount = (theAmmount) => {
        if(theAmmount<= 0){
            return false;
        }
        this.amount = theAmmount;
        return true;        
    }
    this.getAmount = () => {
        return this.amount;
...
function Payment(amount, receiverNew) {
    Activity.call(this, amount);
    this.receiver = receiverNew;
    this.setReceiver = function(newReciever){
        this.receiver = newReciever;        
    }
...
Payment.prototype.setReceiver = (newReciever)=>{
    this.receiver = newReciever;        
}
...
function Refund(amount, senderNew) {
    Activity.call(this, amount);
    this.sender = senderNew;
...
Refund.prototype.setSender = (newSender)=>{
    this.sender = newSender;        
}
